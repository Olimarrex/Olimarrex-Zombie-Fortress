...
//CHANGES: UPDATE ANIMS TO TAKE ON THE SMALLER SAW SIZE.
...
void Blend(CBlob@ this, CBlob@ tobeblended)
{
	...
	{
		this.getSprite().PlaySound("SawOther.ogg");
		this.server_Hit(this, this.getPosition(), Vec2f_zero, 0.05f, Hitters::saw);
	}
...
{
	if (hitBlob !is null && hitBlob !is this) //so we don't magically blend ourselves.
	{
		Blend(this, hitBlob);
	}
}
...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ back = this.addSpriteLayer("back", "/Saw.png", 16, 16);
...
void onTick(CSprite@ this)
{
	...
	if (chop !is null && getSawOn(blob))
	{
		...
		chop.RotateBy(30.0f, Vec2f_zero);
	}
}