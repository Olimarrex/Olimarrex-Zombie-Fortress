...
{
	RunnerTextures@ runner_tex = addRunnerTextures(this, "boneguard", "BoneGuard");
...
{
	ensureCorrectRunnerTexture(this, "boneguard", "BoneGuard");
...
void onRender(CSprite@ this)
{
	...
	if (blob.isKeyPressed(key_action1))
	{
		...
		if ((moddedIsTileSolid(map, tile) || map.isTileGrass(tile.type)) && map.getSectorAtPosition(surface_position, "no build") is null && distance < 16.0f)
		{
