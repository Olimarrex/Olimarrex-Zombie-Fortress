...
void ManageCursors( CBlob@ this )
{
	...
	{		 	
		if (this.isAttached() && this.isAttachedToPoint("GUNNER")) {
			...
			getHUD().SetCursorImage("UndeadBunnyCursor.png", Vec2f(32,32));
		}
	}
}
...
void onRender( CSprite@ this )
{
	...
	DrawCoinsOnHUD( blob, coins, topleft, slotsSize-2 );	
	GUI::DrawIcon( "jclass.png", 19, Vec2f(16, 16), Vec2f(10, 10), 1.0f);;	
}
