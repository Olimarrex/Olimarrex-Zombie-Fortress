...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 1)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("summon zombies"), "Use this to summon 5 friendly zombies.", params );
	}
}
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	...
	if (cmd == this.getCommandID("summon zombies"))
	{
		...
		for (int i = 0; i < zombiesToSpawnCount; i++)
		{
			...
			{
				@zombie = server_CreateBlob( "zombie", caller.getTeamNum(), caller.getAimPos()); 
			}
