...
void tileCheck(CBlob@ this, CMap@ map, Vec2f pos, f32 angle, facing_direction set_facing, spikeCheckParameters@ params)
{
	...
	else if(moddedIsTileSolid(map, t))
	{
...
void onTick(CBlob@ this)
{
	...
	if(getNet().isServer() &&
	        (moddedIsTileSolid(map, map.getTile(pos)) || map.rayCastSolid(pos - this.getVelocity(), pos)))
	{
...
{
	return /* !b.hasTag("dead") fuq dis */ b.hasTag("flesh");
}
