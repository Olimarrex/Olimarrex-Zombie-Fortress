...
{	
	...
	if (r == 0)
	{
		server_CreateBlob( "pcrawler", 1, aimpos );
	}
	else if (r == 1)
	{
		server_CreateBlob( "gasbag", 1, aimpos );
	}				
	else if (r == 2)
	{
		server_CreateBlob( "pankou", 1, aimpos );
	}
	else if (r == 3)
	{
		server_CreateBlob( "greg", 1, aimpos );
	}
	else if (r == 4)
	{
		server_CreateBlob( "catto", 1, aimpos );
	}
	else if (r == 5)
	{
		server_CreateBlob( "zombieknight", 1, aimpos );
	}
	else if (r == 6)
	{
		server_CreateBlob( "skeleton", 1, aimpos );
	}
	else if (r == 7)
	{
		server_CreateBlob( "zombie", 1, aimpos );
	}
	else if (r == 8)
	{
		server_CreateBlob( "wraith", 1, aimpos );
	}
	else if (r == 9)
	{
		server_CreateBlob( "zbison", 1, aimpos );
	}	
