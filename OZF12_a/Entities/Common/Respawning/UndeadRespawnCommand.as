...
{
	addPlayerClass(this, "Undead Builder", "$undead_builder_class_icon$", "undeadbuilder", "Build ALL the towers.");
	addPlayerClass(this, "Undead Knight", "$undead_knight_class_icon$", "undeadknight", "Hack and Slash.");
	addPlayerClass(this, "Undead Archer", "$undead_archer_class_icon$", "undeadarcher", "The Ranged Advantage.");
	addPlayerClass(this, "Undead Mystic", "$undead_mystic_class_icon$", "undeadmystic", "Mr. Magic Man.");	
}
