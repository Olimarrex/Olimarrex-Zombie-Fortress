...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Dormitory", "$dorm$", "dorm", "Switch classes." );
	...
	{
		ShopItem@ s = addShopItem( this, "Grain Nursery", "$grainshop$", "grainnursery", "Grow your only source of food." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 50 );
	}
	{
		ShopItem@ s = addShopItem( this, "Botanical Workshop", "$botanyworkshop$", "botanyworkshop", "Combine seeds to make new plants." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 50 );
	}
	{
		ShopItem@ s = addShopItem( this, "Apothecary", "$apothecary$", "apothecary", "Turn crops into potions!" );
		AddRequirement( s.requirements, "blob", "mat_gold", "Gold", 50 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 100 );
	}
	{
		ShopItem@ s = addShopItem( this, "Grave Yard", "$graveyard$", "graveyard", "Commit yourself to the undead." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 100 );
